...
def team_competition_bommbermanlike_v1_env():
    """Start up a Team config with the competition settings."""
    env = envs.v1.Pomme
    game_type = constants.GameType.Team
    env_entry_point = 'pommerman.envs.v1:Pomme'
    env_id = 'PommeTeamCompetitionBombermanlike-v1'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        # 'num_rigid': constants.NUM_RIGID,
...
def team_competition_bommbermanlike_v1_5_env():
    """Start up a Team config with the competition settings."""
    env = envs.v1_5.Pomme
    game_type = constants.GameType.Team
    env_entry_point = 'pommerman.envs.v1_5:Pomme'
    env_id = 'PommeTeamCompetitionBombermanlike-v15'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        # 'num_rigid': constants.NUM_RIGID,
...
def team_competition_bommbermanlike_v1_4_env():
    """Start up a Team config with the competition settings."""
    env = envs.v1_6.Pomme
    game_type = constants.GameType.Team
    env_entry_point = 'pommerman.envs.v1_6:Pomme'
    env_id = 'PommeTeamCompetitionBombermanlike-v14'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        # 'num_rigid': constants.NUM_RIGID,
...
def team_competition_bommbermanlike_v1_4_longer_env():
    """Start up a Team config with the competition settings."""
    env = envs.v1_6.Pomme
    game_type = constants.GameType.Team
    env_entry_point = 'pommerman.envs.v1_6:Pomme'
    ...
    env_kwargs = {
        ...
        'num_wood': 36,
        'num_items': 20,
        'max_steps': 250,  # ADDED on top of v16 !
        'render_fps': constants.RENDER_FPS,
        'agent_view_size': 3,
        # 'is_partially_observable': True,
        'first_collapse': constants.FIRST_COLLAPSE,
...
def team_competition_bommbermanlike_v1_6_env():
    ...
    game_type = constants.GameType.Team
    env_entry_point = 'pommerman.envs.v1_6:Pomme'
    env_id = 'PommeTeamCompetitionBombermanlike-v16'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        # 'num_rigid': constants.NUM_RIGID,
...
def noradio_competition_env():
    """Start up a team radio config with the default settings."""
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = 'pommerman.envs.v2:Pomme'
    env_id = 'PommeNoRadioCompetition-v2'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        'num_rigid': constants.NUM_RIGID,
